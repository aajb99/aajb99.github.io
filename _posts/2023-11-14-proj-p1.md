...
I find web scraping to be incredibly useful, especially with the internet and its resources available to us. I will continue discussing my analysis on snow accumulation in Utah over time—particularly my EDA and results—in [Utah Snow Accumulation Study: EDA and Findings](https://aajb99.github.io/2023/11/26/proj-p2.html).

For more information on the data I've extracted and the code I used for the extraction/analysis, please see my [github repo](https://github.com/aajb99/stat386_project).