...
Lastly, I ran the following EDA models to determine the distributions of snowpack level based on decade subset combinations:
...
<head>
    ...
    <style>
        ...
        img {
            width: 500px; /* Set the width of your images */
            height: auto; /* Maintain aspect ratio */
        }
    </style>
    <title>Side-by-Side Images</title>
